#This is the main Java code of the plugin. Two additional python scripts are needed for full feature use, without these all functions are still available except the automated ROI determination.
